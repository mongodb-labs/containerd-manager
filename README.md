...
[![CI](https://github.com/Luke-Sanderson/containerd-manager/actions/workflows/ci.yml/badge.svg)](https://github.com/Luke-Sanderson/containerd-manager/actions/workflows/ci.yml)
...
# Git
containerd-manager = { git = "https://github.com/Luke-Sanderson/containerd-manager" }
```
